...
$('body').on('click', '.item-tab__label', function (event) {
	var eq = $(this).index();
	if ($(this).hasClass('parent')) {
		var eq = $(this).parent().index();
	}
	if (!$(this).hasClass('is-activated')) {
		$(this).closest('.tabs').find('.item-tab__label').removeClass('is-activated');
		$(this).addClass('is-activated');
	$(this).closest('.tabs').find('.item-tab__body').removeClass('is-activated').eq(eq).addClass('is-activated');
